			...
			<div class="row">
				<div class="col-12">
					<div class="me-breadcrumb-box">
						<br>
						<br>
						<h1>Menjangkau Lebih Banyak Costumer Anda Dengan Digital Marketing Social Media Ads & Adwords</h1>
						<p><a href="index.html">Service Kami</a>Digital Marketing</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="me-plans-box">
						<div class="me-plan-header">
							<h1 class="me-plan-title">Paket Social Media Ads</h1>
							<div class="me-plan-price">Rp. 1.000.000</div>
						</div>
						...
						<div class="me-plan-footer">
							<button class="me-btn" data-toggle="modal" data-target="#meLogin">Order Sekarang</button>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="me-plans-box">
						<div class="me-plan-header">
							<h1 class="me-plan-title">Paket Google Adwords</h1>
							<div class="me-plan-price">Rp. 1.500.000</div>
						</div>
						<div class="me-plan-body">
							<ul>
								<li>15 Hari Tayangan</li>
				...
				<div class="col-lg-4 col-md-6">
					<div class="me-plans-box">
						<div class="me-plan-header">
							<h1 class="me-plan-title">Custom</h1>
							<div class="me-plan-price">Hubungi Kami</div>
						</div>
						<div class="me-plan-body">
							<h4>Untuk Anda Dengan Harga Khusus</h4>
						</div>
						<div class="me-plan-footer">
							<button class="me-btn">Hubungi Kami</button>
						</div>
						<div class="me-plan-shape">
						</div>
					</div>
